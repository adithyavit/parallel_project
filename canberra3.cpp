...
//finding noise using canberra metric
...
//calculate time
    ...
    cout<<"time taken for canberra metric of filter size 3 is: "<<diff<<" seconds"<<endl;
//output image as file
    imwrite("/home/adithya/Desktop/parallel_opencv/canberra_3.jpg",img);
    return 0;
}
